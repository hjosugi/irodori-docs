...
| --- | --- |
| Start local development | [../README.md](https://github.com/hjosugi/irodori-table/blob/main/README.md), [linux-development.md](linux-development.md) |
...
| Add DB-specific samples or links | [db-feature-samples.md](db-feature-samples.md), [../samples/db-feature-samples.json](https://github.com/hjosugi/irodori-samples/blob/main/db-feature-samples.json) |
| Update public website copy | [site/](https://github.com/hjosugi/irodori-table/blob/main/docs/site/) |
...
| --- | --- |
| Phase-level product direction | [../ROADMAP.md](https://github.com/hjosugi/irodori-table/blob/main/ROADMAP.md) |
...
| DB-specific runnable sample catalog | [db-feature-samples.md](db-feature-samples.md) + [../samples/db-feature-samples.json](https://github.com/hjosugi/irodori-samples/blob/main/db-feature-samples.json) |
| Feature parity and competitive gaps | [feature-matrix.md](feature-matrix.md) |
| Public website/search/blog copy | [site/](https://github.com/hjosugi/irodori-table/blob/main/docs/site/) |
...
| --- | --- |
| Product direction and phase-level goals | [../ROADMAP.md](https://github.com/hjosugi/irodori-table/blob/main/ROADMAP.md) |
| Ticket IDs, dependencies, and done criteria | [implementation-backlog.md](implementation-backlog.md) |
...
| PR expectations | [../CONTRIBUTING.md](https://github.com/hjosugi/irodori-table/blob/main/CONTRIBUTING.md) |
